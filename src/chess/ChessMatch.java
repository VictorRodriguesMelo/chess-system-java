	...
	public boolean getCheckMate() {
		...
		private void validateSourcePosition (Position position) {
			...
			if (!board.piece(position).isThereAnyPossibleMove() ) {
				throw new ChessException("There is no possible moves for the chasen piece.");
			}
		}
		...
		private ChessPiece king(Color color) {
			...
			throw new IllegalStateException("There is not " + color + "king onde the board");
		}
		...
		private void initialSetup() {
	        ...
	        placeNewPiece('f', 8, new Knigth(board, Color.BLACK));
